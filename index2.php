   ...
   <h1> El nombre de el usuario es: 
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="work mb-4 img d-flex align-items-end" style="background-image: url(<?php echo $mascota->getFoto(); ?>);">
            	<a href=<?php echo $mascota->getFoto(); ?> class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4">
	              <div class="text w-100 mb-3">
	              	<span><?php echo $mascota->getNombre(); ?></span>
	              	<h2><a href="work-single.html"><?php echo $mascota->getEspecie(); ?></a></h2>
	              </div>
              </div>
            </div>
          </div>
